...
public class Cyberleg extends Cyberware {
     ...
     */
    private static Cyberware createCyberleg(String name, String install, boolean isFundational, int optionSlots,
        ...
        cyberleg.setIsFundational(isFundational);
    ...
    public static Cyberware CyberlegDynalarTechnologies(){
        return createCyberleg("Cyberleg Dynalar Technologies", CyberwareConstants.HOSPITAL.getValueS(),
    ...
    public static Cyberware CyberlegIEC(){
        return createCyberleg("Cyberleg IEC", CyberwareConstants.HOSPITAL.getValueS(),
    ...
    public static Cyberware CyberlegMilitech(){
        return createCyberleg("Cyberleg Militech", CyberwareConstants.HOSPITAL.getValueS(),
    ...
    public static Cyberware StandardFoot(){
        return createCyberleg("Cyberleg Dynalar Technologies", CyberwareConstants.CLINIC.getValueS(),
